...
const pisces = {
  name: "Pisces",
  description:
    "You are a lovely dreamer who live in bubbles. Natives of this sign are best described as hypersensitive emotional sponges, who are selfless and caring. In short, your personality is creative, sensual, and imaginative and you aspire to achieve total emotional and spiritual harmony.",
...
const aries = {
  name: "Aries",
  description:
    "You are a fire sign with an explosive temperament. You're a stubborn person and often do as you please. That said, your courage and your determination are exemplary as you like to be a pioneer and a leader. Your fiery personality is impatient and opinionated, yet on the flip side, strong, loving and kind.",
...
const taurus = {
  name: "Taurus",
  description:
    "You are an earth sign and like the earth, simple and natural. You aspire to live a quiet and comfortable life and you while you can, avoid complicatons and disputes to enjoy the pleasures of life.",
...
const gemini = {
  name: "Gemini",
  description:
    "You are an air sign and spend your life searching for yourself and seeking knowledge. Driven by great curiosity, you open yourself up fearlessly and wholeheartedly to the world around you. Simply put, you are a gem.",
...
const cancer = {
  name: "Cancer",
  description:
    "You are a water sign and are reputable for your tender, intuitive, loving and sweet personality, which helps you stand out from the crowd. You crave being surrounded, protected and made to feel safe at all times.",
...
const leo = {
  name: "Leo",
  description:
    "When your planet is the sun, it's hard to be discreet! You radiate meaning. it's impossible not to notice your attractive charisma. You love the spot light and enjoy being the center of attention, but can also be very self-conscious at times, especially when you are in love.",
...
const virgo = {
  name: "Virgo",
  description:
    "Prudent and perfectionist, you do nothing at random. Everything is meticulously analyzed and studied. At times, you have a great tendency to engage in self-criticism but that only emphasizes your innate sense of organization and duty.",
...
const libra = {
  name: "Libra",
  description:
    "Your zodiac symbol is the scales of justice, which represent fairness, balance and harmony. You are influenced by Venus, the planet of love and beauty making you extremely charming. You are constantly in search of peace, fairness and balance. Moreover, you are kind, understanding and compassionate with everyone you meet.",
...
const scorpio = {
  name: "Scorpio",
  description:
    "You are a tough nut to crack. Unlike other members of the zodiac, your personality is like no other and is extremely decisive, emotive and mysterious. Passionately expressive, strong, intense and rebellious are amongst some of the best adjectives to describe you.",
...
const sagittarius = {
  name: "Sagittarius",
  description:
    "You are naturally enthusiastic, curious, fun loving, and energetic. There's no question about it, You are one of the biggest wanderers of the zodiac and are on a constant quest for happiness. Your serene, optimistic, and adventurous personality knows no bound as you always strive for positivity. ",
...
const capricorn = {
  name: "Capricorn",
  description:
    "You are especially great at establishing relationships with people. Your traits include being attentive, brave, patient and resistant. You often adopt a defensive and skeptical attitude and may seem cold at first glance but you are fiery underneath all that ice.",
